...
import { connectToChrome, hideChromeWindow, launchChrome } from "./chromeLifecycle.js";
...
export async function resumeBrowserSession(
	...
	if (config?.provider === "m365-copilot") {
		throw new Error("M365 Copilot reattach is not supported yet.");
	}
